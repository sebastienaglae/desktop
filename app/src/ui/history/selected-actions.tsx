...
interface ISelectedActionsProps {
...
export class SelectedActions extends React.Component<
  ISelectedActionsProps,
  ISelectedActionsState
> {
  private readonly loadChangedFilesScheduler = new ThrottledScheduler(200)
  private historyRef: HTMLDivElement | null = null

  public constructor(props: ISelectedActionsProps) {
    super(props)
  ...
  public componentWillUpdate(nextProps: ISelectedActionsProps) {
